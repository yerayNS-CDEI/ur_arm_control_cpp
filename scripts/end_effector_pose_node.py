...
import tf2_ros
import tf_transformations  # para convertir quaternions a euler si quieres
...
class EndEffectorListener(Node):
    ...
    def timer_callback(self):
        try:
            # Cambia "base_link_inertia" por tu frame base real
            # Cambia "wrist_3_link" por el nombre real del frame del end effector
            ...
            self.get_logger().info(f"End Effector Orientation (quaternion): x={rot.x:.3f}, y={rot.y:.3f}, z={rot.z:.3f}, w={rot.w:.3f}")
